...
W5A 后写 REF0 路线检索 brief，同时派发 W5B 结构 critic、REF1 Route Literature Scouts 和 REF2 Human Consultation Recorder，保持三路隔离。Human brief 必须交给真实人；未获得回复时记录缺口，不能由 Agent 补写。

REF1 完成后创建新 Literature Evidence Auditor。你依据 review 写 route-evidence-handoff，交原 Route A/B 作者 W5C 回应；文献和人的意见不直接投票决定 L2。
