...
`Answer Relevance Reviewer` 写 `reviews/answer-relevance-review.md`，检查每问是否直接回答题目动词和交付对象，答案能否从本问真实论证中自然复述，是否有方法无结论、结果无解释、题间依赖缺失、摘要正文结论不闭合，以及次要技术细节是否挤压核心答案。完整答案不因缺少固定结论句而被判为不可见。
